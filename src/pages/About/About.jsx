    ...
    return(
            ...
            <div className=" mt-12 ml-120 mr-120 flex  flex-col text-center gap-20  ">
                ...
                <div className="flex justify-center">
                    <img className="h-120 w-120 rounded-full" src="src\assets\WhatsApp Image 2025-04-13 at 19.26.15_d4e26ecc.jpg" />
                </div>
                ...
                <div className=" ml-10 mr-10 text-start  leading-8 -tracking-50">
                    ...
                    <p class="">For me, coding is more than a skill—it's a way to bring ideas to life and solve meaningful problems. My journey has been fueled by curiosity, resilience, and a commitment to refining my craft. With hands-on experience across the development lifecycle, I focus on delivering solutions that blend functionality with great design.</p><br/>
                    <p class="">Collaborative by nature and detail-oriented in my approach, I aim to leave a lasting impact in the digital world through thoughtful and creative web solutions.</p><br/>
                    <p class="">Don't hesitate to reach out – let's grab a coffee and chat</p><br/>
